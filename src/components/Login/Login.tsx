    ...
    <div className="lg:w-1/3 w-full border-solid border-2 border-gray-300 px-7 py-12  rounded-md bg-white drop-shadow-md">
      ...
      <div className="my-9  w-3/4 m-auto">
        <div>
          ...
          <input placeholder="test@test.com" type="email" value={email} onChange={changeAmount} className="border-b-2 py-1 px-2 text-red placeholder:text-slate-400 text-black  border-gray-300 w-full" />
        </div>
        <div className="mt-10">
          <label htmlFor="" className="text-gray-400 block">Password</label>
          <input type="password" value={pass} onChange={changePass} className="border-b-2 text-black py-1 px-2 border-gray-300 w-full" />
        </div>
      </div>
